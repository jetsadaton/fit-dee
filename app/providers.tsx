...
// - networkMode 'offlineFirst' offline queue (Phase 4) reads from cache while disconnected
...
export function Providers({ children }: { children: ReactNode }) {
  // useState ensures one client per browser session — never recreated on re-render,
